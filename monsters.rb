...
module Monsters
  ...
  class Character < Ephesus::Core::Actor
  ...
  #     Notification = Ephesus::Core::Message.define(:monster_name, type: TYPE)
  ...
  module Commands
    class ChooseMonster < Ephesus::Core::Command
      Event = Ephesus::Core::Message.define(:actor_id, :monster_id)

      Notification = Ephesus::Core::Message.define(:actor_name, :monster_name)
